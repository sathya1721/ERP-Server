                        ...
                        if(!err && response) {
                            ...
                            request.post({ url: setupConfig.image_api_base+'/logo_upload', form: formData }, function (err, response, body) {
                                if(!err && body) {
                                    ...
                                    req.body.seo_details = { page_title: req.body.name, meta_desc: "Ecommerce Application" };
                                    ...
                                    newStore.save(function(err, response) {
                                        if(!err && response)
                                        {
                                            ...
                                            storeService.createStore(storeDetails, adminDetails).then((respData) => {
                                                if(adminDetails.auto_deploy && storeDetails.account_type=='client' && req.body.allow_deploy) {
